...
#define LOCALE_RACESWAP_3 "Wechsel der Rassenvorteile"
...
#define LOCALE_BES_3 "Wechsel zu Blutelfen -"
...
#define LOCALE_DRS_3 "Wechsel zu Draenei"
...
#define LOCALE_DWS_3 "Wechsel zu Zwerge -"
...
#define LOCALE_GNS_3 "Wechsel zu Gnome -"
...
#define LOCALE_HUS_3 "Wechsel zu Menschen -"
...
#define LOCALE_NES_3 "Wechsel zu Nachtelfen -"
...
#define LOCALE_ORC_3 "Wechsel zu Orcs -"
...
#define LOCALE_TUR_3 "Wechsel zu Tauren -"
...
#define LOCALE_TRL_3 "Wechsel zu Trolle -"
...
#define LOCALE_UND_3 "Wechsel zu Verlassene -"
...
public:
    ...
    void OnLogin(Player* Player, bool /*firstLogin*/) override
    {
        ...
        {
            ChatHandler(Player->GetSession()).SendSysMessage("Dieser Server nutzt das |cff4CFF00Racial Trait |rModul.");
        }
    }
};
    ...
    struct npc_race_trait_swapAI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            if (player->IsInCombat())
            {
                ...
                ChatHandler(player->GetSession()).PSendSysMessage("Du befindest dich im Kampf!");
                return true;
            }
            else
            {
        ...
        bool OnGossipSelect(Player* player, Creature* _creature, uint32 /*sender*/, uint32 uiAction)
        {
            ...
            case 1://Blood Elf Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich dem Stolz der Blutelfen", GOSSIP_SENDER_MAIN, 112);
            ...
            case 2://Draenei Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich dem Licht der Draenei", GOSSIP_SENDER_MAIN, 212);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 3://Dwarves Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich dem Eisernen Willen der Zwerge", GOSSIP_SENDER_MAIN, 31);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 4://Gnome Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich der technologischen Macht der Gnome", GOSSIP_SENDER_MAIN, 41);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 5://Human Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich dem menschlichen Geist", GOSSIP_SENDER_MAIN, 51);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 6://Night Elf Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte den den mächtigen Nachtelfen", GOSSIP_SENDER_MAIN, 61);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 7://Orc Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Folge dem Kriegshäuptling und seinen Orcs", GOSSIP_SENDER_MAIN, 71);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 8://Tauren Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich zur Ausdauer der Tauren", GOSSIP_SENDER_MAIN, 81);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 9://Troll Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich dem Voodoo der Trolle", GOSSIP_SENDER_MAIN, 91);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
            ...
            case 10://Undead Selection
                AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Verpflichte dich dem Willen der Verlassenen", GOSSIP_SENDER_MAIN, 101);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedBack, GOSSIP_SENDER_MAIN, 11);
                AddGossipItemFor(player, GOSSIP_ICON_TALK, localizedExit, GOSSIP_SENDER_MAIN, 1111);
...
>>>>>>> 82e87f4683ab4edbd93060c5e7de66a3c5940dab
